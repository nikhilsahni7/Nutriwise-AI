          ...
          <Card className="backdrop-blur-xl bg-white/80 shadow-2xl border-0 relative overflow-hidden">
            ...
            <CardContent className="space-y-8 relative">
              ...
              <button
                ...
                className="w-full max-w-sm h-14 border-2 border-gray-200/50 hover:border-gray-300 hover:bg-white/90 transition-all duration-300 transform hover:scale-105 hover:shadow-lg shadow-sm backdrop-blur-sm rounded-2xl group relative overflow-hidden bg-white"
              >
                {/* Google Button Hover Effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-blue-50/50 to-red-50/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl" />
                ...
                <div className="flex items-center justify-center relative z-10">
                  ...
                  <span className="font-semibold text-black transition-colors duration-200">
                    Sign in with Google
                  </span>
                </div>
              </button>
