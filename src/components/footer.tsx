...
const Footer = () => {
  ...
  const contactInfo = [
    { icon: Mail, text: 'thakur2004harsh@gmail.com' },
    { icon: Phone, text: '+91 9311840704' },
    { icon: MapPin, text: 'IIIT-D' }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              We leverages AI to provide personalized meal recommendations, track nutrient intake, and offer mindful eating practices to support users' physical and emotional well-being.
            </p>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-gray-400">
              © {currentYear} Delta Force. All rights reserved.
            </div>
